...
function PatientInfoPage() {
  ...
  useEffect(() => {
    ...
    if (disease) {
      const newSymptoms = disease.symptoms.map((symptom) => ({
        name: symptom,
        value: "",
      }));
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="mb-4">
              ...
              <input
                ...
                disabled
                className="mt-1 px-3 py-2 w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
              />
            </div>
            <div className="mb-4">
              <label
            ...
            {symptoms.length > 0 && (
              <div className="col-span-2 mb-4">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <button
                    type="submit"
                    className="mt-4 inline-flex items-center px-6 py-3 border border-transparent rounded-md shadow-sm text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                  >
                    Save Symptoms
                  </button>
                </form>
